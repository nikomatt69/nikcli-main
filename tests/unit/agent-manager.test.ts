...
describe('AgentManager', () => {
  ...
  describe('Agent Registration', () => {
    it('should register new agents', () => {
      const _agent = new MockAgent('test-agent-1')
  ...
  describe('Agent Creation and Lifecycle', () => {
    ...
    it('should track active agents', async () => {
      const _agent1 = agentManager.createAgent('mock-agent', 'agent-1')
      const _agent2 = agentManager.createAgent('mock-agent', 'agent-2')
  ...
  describe('Agent Execution', () => {
    ...
    it('should execute tasks successfully', async () => {
      const _agent = agentManager.createAgent('mock-agent', 'executing-agent')
  ...
  describe('Agent Discovery and Querying', () => {
    ...
    it('should filter agents by status', async () => {
      const _agent1 = agentManager.createAgent('mock-agent', 'ready-agent')
      const _agent2 = agentManager.createAgent('mock-agent', 'stopped-agent')
  ...
  describe('Agent Communication and Events', () => {
    ...
    it('should handle inter-agent communication', async () => {
      const _sender = agentManager.createAgent('mock-agent', 'sender')
      const _receiver = agentManager.createAgent('mock-agent', 'receiver')
    ...
    it('should broadcast messages to multiple agents', async () => {
      const _agent1 = agentManager.createAgent('mock-agent', 'broadcast-1')
      const _agent2 = agentManager.createAgent('mock-agent', 'broadcast-2')
  ...
  describe('Resource Management', () => {
    ...
    it('should track agent resource usage', async () => {
      const _agent = agentManager.createAgent('mock-agent', 'resource-agent')
  ...
  describe('Performance Monitoring', () => {
    ...
    it('should track execution metrics', async () => {
      const _agent = agentManager.createAgent('mock-agent', 'metrics-agent')
