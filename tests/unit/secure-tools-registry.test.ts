...
describe('SecureToolsRegistry', () => {
  ...
  describe('File Operations', () => {
    describe('readFile', () => {
      it('should read a file successfully with metadata', async () => {
        ...
        const _filePath = await createTestFile('test.txt', content)
      ...
      it('should handle file not found gracefully', async () => {
        await expect(toolsRegistry.readFile('nonexistent.txt')).rejects.toThrow()
      })

      it('should validate file paths for security', async () => {
        await expect(toolsRegistry.readFile('../../../etc/passwd')).rejects.toThrow()
      })
    ...
    describe('writeFile', () => {
      ...
      it('should handle write permissions errors', async () => {
        ...
        const result = await toolsRegistry
          .writeFile('readonly/file.txt', 'content', {
            skipConfirmation: true,
          })
    ...
    describe('listDirectory', () => {
      ...
      it('should validate directory paths', async () => {
        await expect(toolsRegistry.listDirectory('../../../')).rejects.toThrow()
      })
    })
    ...
    describe('replaceInFile', () => {
      it('should replace content in file', async () => {
        ...
        const result = await toolsRegistry.replaceInFile(
          'test.txt',
          [
      ...
      it('should create backup when requested', async () => {
        ...
        const result = await toolsRegistry.replaceInFile('test.txt', [{ find: 'Original', replace: 'Modified' }], {
          createBackup: true,
          skipConfirmation: true,
        })
  ...
  describe('Command Execution', () => {
    describe('executeCommand', () => {
      ...
      it('should reject dangerous commands without allowDangerous', async () => {
        await expect(toolsRegistry.executeCommand('rm -rf /', { skipConfirmation: true })).rejects.toThrow()
      })
  ...
  describe('Error Handling', () => {
    it('should handle file system errors gracefully', async () => {
      await expect(toolsRegistry.readFile('nonexistent-file.txt')).rejects.toThrow()
    })
  ...
  describe('Integration with External Dependencies', () => {
    it('should handle inquirer prompt errors', async () => {
      ...
      await expect(toolsRegistry.writeFile('test.txt', 'content')).rejects.toThrow('Prompt failed')
    })
    ...
    it('should handle filesystem write errors', async () => {
      ...
      const result = await toolsRegistry
        .writeFile('test.txt', 'content', { skipConfirmation: true })
