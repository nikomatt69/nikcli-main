...
import { type ApprovalConfig, type ApprovalRequest, ApprovalSystem } from '../../../src/cli/ui/approval-system'
...
describe('ApprovalSystem', () => {
  ...
  describe('Quick Approval', () => {
    it('should handle quick approval for simple operations', async () => {
      ...
      const approved = await approvalSystem.quickApproval('Quick Test', 'Simple operation', 'low')
    ...
    it('should reject quick approval when denied', async () => {
      ...
      const approved = await approvalSystem.quickApproval('Quick Test', 'Simple operation', 'medium')
  ...
  describe('File Approval', () => {
    it('should request approval for file operations with diff preview', async () => {
      ...
      const approved = await approvalSystem.requestFileApproval('File Changes', fileDiffs, 'medium')
  ...
  describe('Command Approval', () => {
    it('should request approval for safe commands', async () => {
      ...
      const approved = await approvalSystem.requestCommandApproval('npm', ['install'], '/test/dir')
    ...
    it('should assess high risk for dangerous commands', async () => {
      ...
      const approved = await approvalSystem.requestCommandApproval('rm', ['-rf', '/important'], '/test/dir')
  ...
  describe('Package Approval', () => {
    it('should request approval for package installation', async () => {
      ...
      const approved = await approvalSystem.requestPackageApproval(['react', 'typescript'], 'npm', false)
    ...
    it('should assess higher risk for global packages', async () => {
      ...
      const approved = await approvalSystem.requestPackageApproval(['nodemon'], 'npm', true)
