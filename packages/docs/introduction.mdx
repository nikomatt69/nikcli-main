...
<CardGroup cols={2}>
  <Card title="🤖 Universal Agent" icon="robot">
    **47 Capabilities** - Single comprehensive agent handling all development tasks through cognitive orchestration
  </Card>
...
### 🛠️ **144 Commands** organized into logical categories:
