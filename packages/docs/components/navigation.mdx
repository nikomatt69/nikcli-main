...
import { useTerminal, Box, Menu } from "nikcli-tui";
...
const mainMenu = new Menu({
  ...
  items: [
    ...
    { label: "💾 Save File", action: "file:save" },
    { separator: true },
    { label: "🔨 Settings", action: "settings" },
    { label: "❓ Help", action: "help" },
    { separator: true },
    { label: "🚪 Exit", action: "exit", style: { fg: "red" } },
  ],
  onSelect: (item) => {
  ...
  items: [
    {
      ...
      submenu: [
        ...
        { separator: true },
        {
          label: "📤 Export",
          submenu: [
            { label: "📋 Copy to Clipboard", action: "export:clipboard" },
            { label: "📁 Save as JSON", action: "export:json" },
            { label: "📊 Save as CSV", action: "export:csv" },
          ],
        },
      ],
    },
    {
      ...
      submenu: [
        ...
        { separator: true },
        { label: "✂️ Cut", action: "edit:cut", shortcut: "Ctrl+X" },
    ...
    },
    {
      label: "🤖 AI",
      submenu: [
        { label: "💬 Start Chat", action: "ai:chat" },
        { label: "✨ Complete Code", action: "ai:complete" },
        { label: "🔍 Analyze Code", action: "ai:analyze" },
        { separator: true },
        {
          label: "🔨 Model Settings",
          submenu: [
            { label: "🧠 GPT-4", action: "ai:model:gpt4" },
            { label: "🎭 Claude", action: "ai:model:claude" },
            { label: "🏠 Local (Ollama)", action: "ai:model:ollama" },
          ],
        },
      ],
    },
    ...
    const menuItems = [
      ...
      // Bookmarks submenu
      {
        ...
        submenu: this.bookmarks.map((bookmark) => ({
          label: `📁 ${this.getFileName(bookmark)}`,
...
class AdvancedTabs extends Tabs {
  ...
  private markTabUnsaved(tabId: string) {
    ...
    this.updateTabLabel(tabId, this.getTabLabel(tabId) + " •");
  }

  private markTabSaved(tabId: string) {
    this.unsavedChanges.delete(tabId);
    const label = this.getTabLabel(tabId).replace(" •", "");
...
<CardGroup cols={2}>
  ...
  <Card title="AI Integration" icon="brain" href="/ai/overview">
    Combine navigation with AI-powered applications
  </Card>
  <Card title="Complete Examples" icon="code" href="/examples/overview">
    See navigation components in real applications
  </Card>
  <Card title="Layout Components" icon="grid-2" href="/components/layout">
