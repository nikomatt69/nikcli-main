...
export class WorkflowOrchestrator {
   ...
   */
  async executeChainWithAgent(chainId: string, agentId: string, initialParams: Record<string, any> = {}): Promise<WorkflowResult> {
    try {
   ...
   */
  private async performSafetyChecks(step: WorkflowStep, context: WorkflowContext, checks: SafetyCheck[]): Promise<void> {
