import { EventBus, EventTypes, AgentEvent } from './event-bus';
...
export class AgentRouter {
    ...
    private generateReasoningForScore(agent: AgentInstance, task: AgentTask, analysis: TaskAnalysis, score: number): string {
...
export interface RoutingRule {
    ...
    agentSelector?: (candidates: AgentCandidate[], task: AgentTask, analysis: TaskAnalysis) => Promise<AgentCandidate | null>;
}
