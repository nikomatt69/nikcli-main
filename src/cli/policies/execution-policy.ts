...
export class ExecutionPolicyManager {
  ...
  private initializeToolPolicies(): void {
    ...
    const riskyTools = [
      { name: 'write_file', category: 'file' as const, description: 'Write content to files', riskyOps: ['system files', 'config files'] },
      { name: 'edit_file', category: 'file' as const, description: 'Edit existing files', riskyOps: ['destructive edits', 'system files'] },
      { name: 'multi_edit', category: 'file' as const, description: 'Batch file editing', riskyOps: ['multiple files', 'batch operations'] },
      ...
      { name: 'git_commit', category: 'git' as const, description: 'Git commit operation', riskyOps: ['permanent changes', 'history modification'] },
      { name: 'git_push', category: 'git' as const, description: 'Push to remote repository', riskyOps: ['remote changes', 'public repositories'] },
      { name: 'npm_install', category: 'package' as const, description: 'Install npm packages', riskyOps: ['global installations', 'security vulnerabilities'] },
    ];
    ...
    const dangerousTools = [
      { name: 'execute_command', category: 'system' as const, description: 'Execute system commands', riskyOps: ['system modification', 'data loss', 'security bypass'] },
      { name: 'delete_file', category: 'file' as const, description: 'Delete files', riskyOps: ['data loss', 'irreversible'] },
      { name: 'git_reset', category: 'git' as const, description: 'Git reset operations', riskyOps: ['history loss', 'irreversible'] },
      { name: 'network_request', category: 'network' as const, description: 'Make network requests', riskyOps: ['data exfiltration', 'external communication'] },
    ];
   ...
   */
  async shouldApproveToolOperation(toolName: string, operation: string, args: any): Promise<ToolApprovalRequest | null> {
   ...
   */
  private assessToolRisk(toolName: string, operation: string, args: any, policy: ToolPolicy): {
    level: 'low' | 'medium' | 'high';
    reasons: string[];
    affectedFiles?: string[];
    irreversible?: boolean;
