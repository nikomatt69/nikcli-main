...
export class MiddlewareContextBuilder {
  static fromModuleContext(moduleContext: ModuleContext, metadata: Record<string, any> = {}): MiddlewareContext {
    return {
      ...moduleContext,
      requestId: uuidv4(),
      timestamp: new Date(),
  ...
  static enhance(context: MiddlewareContext, additionalMetadata: Record<string, any>): MiddlewareContext {
    return {
      ...context,
      metadata: {
        ...context.metadata,
