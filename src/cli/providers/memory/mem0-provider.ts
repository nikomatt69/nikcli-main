...
export class Mem0Provider extends EventEmitter {
  ...
  private extractConcepts(content: string): string[] {
    ...
    const techKeywords = [
      'ai', 'machine learning', 'neural network', 'api', 'database', 'server',
      'algorithm', 'data', 'model', 'training', 'inference', 'embedding',
      'vector', 'similarity', 'classification', 'prediction', 'optimization'
    ];
