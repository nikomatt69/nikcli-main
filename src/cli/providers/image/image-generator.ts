...
export class ImageGenerator extends EventEmitter {
  ...
  private calculateCostEstimate(model: string, size: string, quality: string): number {
    ...
    const costs = {
      ...
      'gpt-image-1': {
        '1024x1024': { low: 0.020, medium: 0.070, high: 0.190, auto: 0.070 },
        '1536x1024': { low: 0.030, medium: 0.100, high: 0.280, auto: 0.100 },
        '1024x1536': { low: 0.030, medium: 0.100, high: 0.280, auto: 0.100 }
      }
    };
  ...
  getAvailableModels(): string[] {
    ...
    try {
      const openaiKey = simpleConfigManager.getApiKey('dall-e-3') ||
