...
import { redisProvider, RedisProvider, CacheEntry } from '../providers/redis/redis-provider';
import { smartCache, SmartCacheEntry, SmartCacheManager } from '../core/smart-cache-manager';
      ...
      if (this.shouldUseFallback(strategy, !redisSuccess)) {
        try {
          ...
          await this.smartCache.setCachedResponse(
            ...
            context,
            { tokensSaved, responseTime, ...metadata }
          );
          smartSuccess = true;
        } catch (error: any) {
