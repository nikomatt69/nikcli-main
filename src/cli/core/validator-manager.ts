...
export class ValidatorManager extends EventEmitter {
  ...
  async validateWithCognition(context: ValidationContext): Promise<IntelligentValidationResult> {
    ...
    advancedUI.logInfo(`🧠 Cognitive analysis: ${cognition.intent} (${cognition.complexity}, risk: ${cognition.riskLevel})`);
   ...
   */
  private inferIntent(operation: string, content: string): 'create' | 'modify' | 'fix' | 'enhance' | 'refactor' | 'analyze' {
