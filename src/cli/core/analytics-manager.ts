...
export class AnalyticsManager {
  ...
  getSummary(): AnalyticsSummary {
    ...
    return {
      ...
      averageResponseTime:
        responses.length > 0 ? responses.reduce((sum, e) => sum + e.data.processingTime, 0) / responses.length : 0,
  ...
  generateInsights(): string[] {
    ...
    const mostUsedTool = Object.entries(summary.mostUsedTools).sort(([, a], [, b]) => b - a)[0]
