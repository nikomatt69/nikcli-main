...
export class ToolRouter extends EventEmitter {
    ...
    private toolKeywords: ToolKeyword[] = [
        ...
        {
            tool: 'web_search',
            keywords: ['search', 'find', 'information', 'documentation', 'stackoverflow', 'github', 'medium', 'blog', 'tutorial', 'guide', 'how to', 'best practice', 'update', 'news', 'version'],
            priority: 8,
        ...
        {
            tool: 'ide_context',
            keywords: ['environment', 'editor', 'ide', 'workspace', 'project', 'structure', 'dependencies', 'package.json', 'git', 'branch', 'commit', 'status', 'open files', 'recent'],
            priority: 7,
        ...
        // Semantic Search Tools
        {
            ...
            keywords: ['similar', 'same', 'pattern', 'model', 'example', 'like this', 'same type', 'similar function', 'similar component', 'implementation'],
            priority: 9,
        ...
        {
            tool: 'code_analysis',
            keywords: ['analyze', 'quality', 'issues', 'bug', 'errors', 'improve', 'optimize', 'refactor', 'refactoring', 'clean', 'security', 'performance', 'complexity'],
            priority: 8,
        ...
        // Dependency Analysis Tools
        {
            ...
            keywords: ['dependencies', 'package', 'npm', 'yarn', 'node_modules', 'vulnerabilities', 'security', 'update', 'outdated', 'version', 'lock', 'package-lock', 'yarn.lock'],
            priority: 7,
        ...
        {
            tool: 'git_workflow',
            keywords: ['git', 'commit', 'branch', 'merge', 'pull', 'push', 'repository', 'repo', 'workflow', 'history', 'log', 'status', 'changes', 'diff', 'conflict', 'rebase', 'cherry-pick'],
            priority: 6,
        ...
        {
            tool: 'run_command',
            keywords: ['execute', 'run', 'command', 'script', 'build', 'test', 'install', 'start', 'dev', 'development', 'production', 'deploy', 'deployment'],
            priority: 3,
    ...
    analyzeMessage(message: CoreMessage): ToolRecommendation[] {
        ...
        for (const toolKeyword of this.toolKeywords) {
            const matches = toolKeyword.keywords.filter(keyword =>
    ...
    async routeWithCognition(
        ...
        try {
            ...
            const toolCandidates = await this.scoreToolsMultiDimensional(
                ...
                { ...context, availableTools: validatedTool }
            );
