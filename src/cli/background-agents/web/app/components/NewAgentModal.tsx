    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white dark:bg-gray-800 rounded-lg w-full max-w-2xl p-6 max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Create New Background Agent</h2>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit}>
          {/* Repository */}
          <div className="mb-4">
            <label className="block font-medium mb-2 text-gray-900 dark:text-white">Repository</label>
            <input
              type="text"
              value={formData.repo}
          ...
          {/* Branch */}
          <div className="mb-4">
            <label className="block font-medium mb-2 text-gray-900 dark:text-white">Base Branch</label>
            <input
              type="text"
          ...
          {/* Task Description */}
          <div className="mb-4">
            <label className="block font-medium mb-2 text-gray-900 dark:text-white">Task Description</label>
            <textarea
              value={formData.task}
          ...
          {/* Playbook (Optional) */}
          <div className="mb-4">
            <label className="block font-medium mb-2 text-gray-900 dark:text-white">Playbook (Optional)</label>
            <input
              type="text"
          ...
          <details className="mb-4 border border-gray-200 dark:border-gray-700 rounded-lg p-4">
            ...
            <div className="space-y-4 mt-4">
              <div>
                <label className="block text-sm mb-1 text-gray-700 dark:text-gray-300">Time Limit (minutes)</label>
                <input
                  type="number"
              ...
              <div>
                <label className="block text-sm mb-1 text-gray-700 dark:text-gray-300">Max Tool Calls</label>
                <input
                  type="number"
              ...
              <div>
                <label className="block text-sm mb-1 text-gray-700 dark:text-gray-300">Max Memory (MB)</label>
                <input
                  type="number"
