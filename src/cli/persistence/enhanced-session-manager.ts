...
import { enhancedSupabaseProvider, SupabaseSession } from '../providers/supabase/enhanced-supabase-provider';
...
export class EnhancedSessionManager extends EventEmitter {
   ...
   */
  async loadSession(id: string, options?: { preferLocal?: boolean; skipCache?: boolean }): Promise<EnhancedSessionData | null> {
   ...
   */
  async saveSession(session: EnhancedSessionData, options?: { localOnly?: boolean; skipCache?: boolean }): Promise<SessionSyncResult> {
