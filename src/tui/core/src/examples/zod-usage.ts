import { z } from 'zod'
import { type BoxSchema, ButtonSchema, type ComponentSchemas, type TextSchema } from '../types/component-schemas'
import {
  componentValidator,
  validateComponent,
...
console.log('Button has "text" property:', componentValidator.hasProperty('button', 'text'))
console.log('Button has "unknownProp" property:', componentValidator.hasProperty('button', 'unknownProp'))
...
function createComponent<T extends keyof typeof ComponentSchemas>(componentName: T, props: any) {
...
const _typedButtonProps: ButtonProps = {
  text: 'Typed Button',
  top: 0,
  left: 0,
  focusable: true,
