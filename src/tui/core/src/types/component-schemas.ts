import { z } from 'zod'
import { BasePropsSchema, ComponentSizeSchema, ComponentVariantSchema } from './schemas'
...
export const TextInputSchema = BasePropsSchema.extend({
  ...
  onKeyPress: z.function().args(z.string(), z.any()).returns(z.void()).optional(),
})
...
export const TreeSchema = BasePropsSchema.extend({
  ...
  onNodeExpand: z.function().args(z.string(), z.boolean()).returns(z.void()).optional(),
})
