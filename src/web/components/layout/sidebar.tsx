...
import { Activity, Bell, Briefcase, Camera, Github, LayoutDashboard, Settings, X, Zap } from 'lucide-react'
  ...
  return (
    <div className="flex h-full w-full flex-col bg-card/95 backdrop-blur-xl border-r border-border/50">
      ...
      >
        ...
        {/* Mobile Close Button */}
        {onClose && (
          <button onClick={onClose} className="lg:hidden p-2 rounded-lg hover:bg-accent transition-colors">
