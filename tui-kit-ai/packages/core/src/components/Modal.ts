...
export class Modal implements Component<Widgets.BoxElement> {
  ...
  constructor(props: ModalProps) {
    ...
    const el = blessed.box({ parent: overlay, width: '70%', height: '60%', top: 'center', left: 'center', border: 'line', style: computeBlessedStyle(theme, props), label: props.title || ' Modal ' });
